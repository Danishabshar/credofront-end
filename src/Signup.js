...
//mongodb://127.0.0.1:27017/
    ...
    const Senddata = () => {
        ...
        axios({
          url: "   https://credobackend.herokuapp.com/signup",
          method: "POST",
          headers: {
  ...
  return (
    <div>
      ...
      <div className='signup'>
        <div className='sign'>
        <h1 className='h1logo'>credogym</h1> <br/>
 ...
 <div className='input2'>
    <label>Trainer:</label>
    <input className='rad'   type="radio" name='userType' value="Trainer" onChange={(e)=>{setData({...data,userType:e.target.value})}}/>
    <label>Joiner:</label>
    <input  className='rad'   type="radio" name='userType' value="Joiner" onChange={(e)=>{setData({...data,userType:e.target.value})}}/>
    </div>
